...
**[Watch on YouTube](https://youtu.be/fT_jtN0sJj8)**
...
A fully playable D&D campaign run by a team of AI agents. You type what your character does, and the **Game Master** agent decides what happens, delegating to specialists instead of hallucinating:
...
- **The Dice Tool**: real randomness in Python, not LLM-made-up numbers. Supports full dice notation (`1d20`, `3d6+2`, and so on).
...
- **[LangGraph](https://langchain-ai.github.io/langgraph/)**: agent orchestration, plus `langgraph-supervisor` for the GM
...
*Made by [Shaurya Kumar](https://github.com/ShauryaKumar09). Don't forget to star the repo if you enjoyed it!*
